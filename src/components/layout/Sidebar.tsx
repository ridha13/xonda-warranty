...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen fixed right-0 top-0 shadow-2xl z-50 overflow-y-auto">
      {/* Logo Section */}
            ...
            return (
              <div key={`divider-${index}`} className="my-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 px-2">إدارة النظام</span>
                  <div className="flex-1 h-px bg-gray-700"></div>
                </div>
              </div>
            );
